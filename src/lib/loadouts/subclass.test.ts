...
test("fragment changes keep the builder snapshot in sync and leave the optimizer breakdown alone", () => {
  ...
  data.builder = { targets: zero, major: 0, setReqs: {}, exoticName: null, exoticPerks: [null, null], allowTuning: true, balancedTuning: true, legacyExotics: true, lowerTierArmor: false, powerRange: { enabled: false, bounds: null, weapons: [null, null, null], dreamersBond: false, legacyArmor: false }, activeSubclass: "Arc", fragmentHashes: [201] };
