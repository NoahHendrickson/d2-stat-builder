...
test("fragment changes keep the builder snapshot in sync and leave the optimizer breakdown alone", () => {
  ...
  data.builder = { targets: zero, major: 0, setReqs: {}, exoticName: null, exoticPerks: [null, null], allowTuning: true, balancedTuning: true, legacyExotics: true, dreamersBond: false, festivalMasks: false, powerRange: { enabled: false, min: 0, max: 0, weapons: [null, null, null] }, activeSubclass: "Arc", fragmentHashes: [201] };
