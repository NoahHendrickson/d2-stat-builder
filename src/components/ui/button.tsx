  ...
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-[6px] border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        outlineSubtle:
          "relative isolate font-normal text-muted-foreground active:translate-y-0.5 before:absolute before:-inset-x-px before:-top-px before:-bottom-[3px] before:z-[-2] before:rounded-[6px] before:border before:border-[var(--neutral-line)] before:bg-[var(--neutral-shadow)] before:content-[''] active:before:-bottom-px after:absolute after:-inset-px after:z-[-1] after:rounded-[6px] after:border after:border-[var(--neutral-line)] after:bg-background after:transition-colors after:content-[''] hover:text-foreground hover:after:bg-muted focus-visible:after:border-ring",
        secondary:
