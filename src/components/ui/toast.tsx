...
function Toast({ className, ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      data-slot="toast"
      className={cn(
        "group/toast pointer-events-auto absolute right-0 bottom-0 z-[calc(1000-var(--toast-index))] d2-slate w-full origin-bottom rounded-2xl border text-popover-foreground shadow-lg will-change-transform outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 d2:rounded-none d2:border-foreground/8 d2:shadow-[0_8px_24px_rgb(0_0_0/0.45)] d2:focus-visible:border-outline-strong d2:focus-visible:ring-0",
...
function ToastClose({
  ...
  return (
    <TooltipLabel label="Close toast">
