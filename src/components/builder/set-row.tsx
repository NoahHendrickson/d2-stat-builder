    ...
    <div className="group/set-row relative col-span-full grid grid-cols-subgrid items-center before:absolute before:inset-y-0 before:-left-7 before:w-7">
      ...
      <TooltipLabel label={pinned ? "Unpin set" : "Pin set"}>
        <button
          ...
          className={cn(
            "absolute top-1/2 -left-7 flex size-6 -translate-y-1/2 items-center justify-center rounded-none transition-opacity outline-none focus-visible:opacity-100 focus-visible:ring-1 focus-visible:ring-outline-strong",
            pinned
              ? "text-foreground"
